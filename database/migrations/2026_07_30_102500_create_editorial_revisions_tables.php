...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (!Schema::hasTable('editorial_revisions')) {
        ...
        if (!Schema::hasTable('editorial_revision_files')) {
        ...
        if (!Schema::hasTable('editorial_revision_corrections')) {
        ...
        if (!Schema::hasTable('editorial_revision_glossaries')) {
