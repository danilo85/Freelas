            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                ...
                <div class="space-y-4">
                    ...
                    <div class="space-y-4">
                        ...
                        <!-- Lista de fotos carregadas na galeria com inputs de ordenação sequencial -->
                                ...
                                <template x-for="(item, index) in galleryFiles" :key="index">
                                    <div class="flex items-center justify-between gap-3 p-2 bg-slate-50 border border-slate-150 rounded-[5px]">
                                        <div class="flex items-center gap-3 min-w-0">
                                            ...
                                            <span class="text-xs text-slate-700 font-medium truncate max-w-[150px]" :title="item.name" x-text="item.name"></span>
                                        </div>
...
<script>
    function portfolioForm() {
        return {
            ...
            description: `{!! addslashes($projectData["description"] ?? "") !!}`,
            technologies: '',
            redirectUrl: '',
            status: 'rascunho',
            isFeatured: false,
