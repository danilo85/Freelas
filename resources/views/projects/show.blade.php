            ...
            <div class="space-y-4 font-semibold text-slate-700" x-data="{ 
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <button type="button" @click="navigator.clipboard.writeText(projectTitle + ' - ' + sysUrl); copiedSys = true; setTimeout(() => copiedSys = false, 2000)" class="absolute right-2.5 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600" title="Copiar Nome e Link">
                ...
                <div class="space-y-2 border-t border-slate-100 pt-3">
                    ...
                    @if($proposal->custom_hash)
                        <div x-show="!showCustomForm" class="relative">
                            ...
                            <button type="button" @click="navigator.clipboard.writeText(projectTitle + ' - ' + custUrl); copiedCust = true; setTimeout(() => copiedCust = false, 2000)" class="absolute right-2.5 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600" title="Copiar Nome e Link">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-2.5 pt-1">
                    <button type="button" @click="navigator.clipboard.writeText(projectTitle + ' - ' + (custUrl ? custUrl : sysUrl)); copiedSys = true; setTimeout(() => copiedSys = false, 2000)" class="flex items-center justify-center gap-2 py-2.5 px-4 bg-primary-600 hover:bg-primary-700 text-white text-sm font-bold rounded-[5px] transition-colors shadow-sm">
