                ...
                >
                    ...
                    >
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            @php
                                $firstLetter = mb_strtoupper(mb_substr($project->client->name, 0, 1));
                        ...
                        <div class="flex flex-wrap items-center justify-between pt-1 gap-1">
                            ...
                            <div class="flex items-center gap-1" x-data="{ copied: false }">
                                @if($activeUrl)
                                    <!-- Copiar Link Ativo -->
                                    <button type="button" 
                                            @click.stop="navigator.clipboard.writeText('{{ addslashes($project->title) }} - {{ $activeUrl }}'); copied = true; setTimeout(() => copied = false, 2000)" 
                                            ...
                                            title="Copiar Nome e Link Ativo da Proposta">
