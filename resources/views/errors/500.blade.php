...
<head>
    ...
    <style>
        .glow-effect {
            box-shadow: 0 0 80px 10px rgba(244, 63, 94, 0.15);
        }
    </style>
</head>
<body class="bg-[#0b0f19] font-sans text-slate-300 antialiased min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
    ...
    <div class="absolute bottom-[-20%] right-[-20%] w-[60%] h-[60%] rounded-full bg-violet-500/10 blur-[120px] pointer-events-none"></div>
    ...
    <div class="max-w-lg w-full text-center space-y-8 relative z-10">
        ...
        <div class="space-y-3">
            <span class="text-xs font-black uppercase tracking-widest text-rose-400 font-outfit">Erro 500 - Instabilidade Detectada</span>
            ...
            <p class="text-sm text-slate-400 leading-relaxed max-w-md mx-auto">
                Desculpe, ocorreu uma instabilidade temporária no servidor do sistema. Nossa equipe técnica já foi notificada para verificar o problema.
            </p>
        </div>
        ...
        <div class="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-md max-w-sm mx-auto space-y-4 text-left">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h4 class="text-xs font-bold text-white uppercase tracking-wider">Falha de Processamento</h4>
