...
@section('title', 'Nova Conta Bancária - Gestor de Freelas')
@section('page_title', 'Cadastrar Conta Bancária')
...
<div x-data="bankAccountForm()" class="space-y-6">
    ...
    <!-- Grid Principal: Formulário (Esquerda) + Preview em Tempo Real (Direita) -->
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
        
        <!-- Formulário de Cadastro -->
        <div class="bg-white rounded-[5px] border border-slate-200 p-5 sm:p-8 space-y-6 lg:col-span-2">
            <div>
                <h2 class="text-xl font-bold text-slate-900">Nova Conta Bancária</h2>
                <p class="text-xs text-slate-400 mt-1">Registre suas contas correntes ou digitais para controle financeiro e associação de recebimentos.</p>
            </div>
