...
@section('title', 'Novo Cartão de Crédito - Gestor de Freelas')
@section('page_title', 'Cadastrar Cartão de Crédito')
...
<div x-data="creditCardForm()" class="space-y-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
        ...
        <div class="bg-white rounded-[5px] border border-slate-200 p-5 sm:p-8 space-y-6 lg:col-span-2">
            <div>
                <h2 class="text-xl font-bold text-slate-900">Novo Cartão de Crédito</h2>
                <p class="text-xs text-slate-400 mt-1">Cadastre seus cartões de crédito para registrar despesas e controle de limite.</p>
            </div>

            <form action="{{ route('credit-cards.store') }}" method="POST" class="space-y-6">
                @csrf
                ...
                <div class="space-y-1.5">
                    ...
                    <textarea 
                        ...
                        placeholder="Adicione informações sobre limite adicional, anuidades ou observações..."
        ...
        <div class="sticky top-6 space-y-4">
            ...
            <div class="bg-blue-50 border border-blue-200 rounded-[5px] p-4 text-xs text-blue-800 leading-relaxed">
                <strong>💡 Dica Visual:</strong> O layout do cartão de crédito responde em tempo real à bandeira (Visa, Mastercard, etc.) e ao banco selecionado para dar a sensação de carteira digital premium.
            </div>
        </div>
