                    ...
                    <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-4 rounded-[5px] shadow-xs flex items-center justify-between gap-4">
                        ...
                        <div class="flex items-center gap-2 shrink-0">
                            ...
                            <button type="button" 
                                    ...
                                    @click="confirmDeleteFile($el.dataset.fileId, $el.dataset.filename)" 
                                    class="w-8 h-8 bg-rose-50 hover:bg-rose-100 text-rose-700 dark:bg-rose-950/40 dark:hover:bg-rose-900/60 dark:text-rose-300 rounded-[5px] flex items-center justify-center transition-colors cursor-pointer" 
