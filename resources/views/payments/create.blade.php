...
@section('title', 'Registrar Pagamento - Gestor de Freelas')
@section('page_title', 'Registrar Pagamento')
...
<div class="max-w-4xl mx-auto space-y-6" x-data="paymentForm()" x-init="init()">
    ...
    <!-- Título Principal -->
    <div>
        <h1 class="text-2xl font-black text-slate-800">Registrar Recebimento</h1>
        <p class="text-sm text-slate-500 font-medium mt-1">Gere uma transação de entrada vinculando pagamentos aos seus orçamentos aprovados.</p>
    </div>
            ...
            >
                ...
                <div class="flex flex-col items-center justify-center space-y-1">
                    ...
                    <p class="text-xs text-slate-400 font-medium">
                        Aceita arquivos PDF, XML, PNG ou JPG de até 10MB
                    </p>
                </div>
            </div>
            @error('invoice')
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input 
                            ...
                            placeholder="R$ 0,00"
                            class="w-full px-4 py-2.5 rounded-[5px] border border-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 transition-all font-bold text-emerald-650"
                        />
                    </div>
                </div>
...
<script>
    function paymentForm() {
        return {
            ...
            init() {
                // Initialize default amount if pre-selected project and amount is empty
                if (this.selectedProjectId && !this.amount) {
                    this.updateAmount();
                }
            },
