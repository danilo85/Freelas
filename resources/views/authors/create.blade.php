...
@section('title', 'Novo Autor - Gestor de Freelas')
@section('page_title', 'Cadastrar Autor')

@section('content')
<div x-data="authorCreateForm()" class="space-y-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
        ...
        <div class="bg-white rounded-[5px] border border-slate-200 p-5 sm:p-8 space-y-6 lg:col-span-2">
            <div>
                <h2 class="text-xl font-bold text-slate-900">Novo Autor</h2>
                <p class="text-xs text-slate-400 mt-1">Insira as informações do autor para registrá-lo na sua base comercial.</p>
            </div>
